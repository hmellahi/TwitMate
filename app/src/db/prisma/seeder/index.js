...
var generateUsers_1 = require("./generateUsers");
var removeFakeData_1 = require("./removeFakeData");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, removeFakeData_1.default)()];
                case 1:
                    _a.sent();
                    console.log("Fake users, their posts, and post images have been removed.");
                    // // Generate fake users
                    console.log("Generating Fake Users");
                    return [4 /*yield*/, (0, generateUsers_1.default)()];
                case 2:
                    _a.sent();
